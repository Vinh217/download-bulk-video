...
def write_to_excel(videos, username):
    excel_file_name = f"TikTok Videos {username}.xlsx"
    excel_file_path = os.path.join(f"./tiktok/{username}", excel_file_name)
    wb = Workbook()
    ws = wb.active
    ...
    for idx, video in enumerate(videos, 1):
        ...
        ws.cell(row=row, column=3, value=video_link)
    ...
    try:
        ...
        class editVideo:
            ...
            def __init__(self):
                ...
                if __name__ == "__main__":
                    ...
                    os.system('cls')
                    banner = f"""{Fore.MAGENTA}edit-video"""
        ...
        class downKuaishou():
            ...
            def __init__(self):
                ...
                if __name__ == "__main__":
                    os.system('cls')
                    banner = f"""{Fore.MAGENTA} Kuaishou-dl"""
                    print(Center.XCenter(banner))
                    print(f'{Fore.GREEN}')
